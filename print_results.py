...
def print_results(results_dic, results_stats_dic, model, 
    ...
    #summary statistics percentages only
    print(" ")
    for key in results_stats_dic:
        if key.startswith('p'):
           print("{:20}: {}".format(key, results_stats_dic[key])) 
    if (print_incorrect_dogs and ( (results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs'])!= ['n_images'] ) ):
        ...
        for key in results_dic:
            if (results_dic[key][3]==0 and results_dic[key][4]==1) or (results_dic[key][3]==1 and results_dic[key][4]==0):
                print("{:20}: {}".format(key, results_dic[key]))
    #incorrect bereds                    
